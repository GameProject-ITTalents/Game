        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-1">
                <div class="intro-message">
                    <h1>Super Mario</h1>
                    <h3>IT Talents Style</h3>
                    <hr class="intro-divider">
                    <ul class="list-inline intro-social-buttons">
                        <li style="margin: 10px">
                            <a href="{{ url('/game') }}" class="btn btn-default btn-lg"><i class="fa fa-gamepad fa-fw"></i> <span class="network-name">Play</span></a>
                        </li>
                        <br>
                        <li style="margin: 10px">
                        ...
                        <br>
                        <li style="margin: 10px">
                            <a href="{{ url('/about') }}" class="btn btn-default btn-lg"><i class="fa fa-info fa-fw"></i> <span class="network-name">About</span></a>
                        </li>
                    </ul>
                </div>
            </div>
